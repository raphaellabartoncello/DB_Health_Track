...
CREATE TABLE t_cep (
    ...
    t_logradouro_cd_logradouro  INTEGER NOT NULL,
...
CREATE TABLE t_compra (
    t_pedido_cd_pedido     INTEGER NOT NULL,
    t_cadastro_cd_usuario  INTEGER NOT NULL,
...
CREATE TABLE t_emocional (
    cd_emocional              INTEGER NOT NULL,
    t_lista_emo_cd_lista_emo  INTEGER NOT NULL,
    t_cadastro_cd_usuario     INTEGER NOT NULL,
    dt_atualizacao            DATE NOT NULL
);
...
CREATE TABLE t_endereco (
    t_cep_cd_endereco      INTEGER NOT NULL,
    t_cadastro_cd_usuario  INTEGER NOT NULL,
...
CREATE TABLE t_h_dormidas (
    cd_hdormidas                INTEGER NOT NULL,
    t_lista_hdor_cd_lista_hdor  INTEGER NOT NULL,
    t_cadastro_cd_usuario       INTEGER NOT NULL,
    dt_atualizacao              DATE NOT NULL
);
...
CREATE TABLE t_imc (
    ...
    t_cadastro_cd_usuario   INTEGER NOT NULL,
    t_tipo_imc_cd_tipo_imc  INTEGER NOT NULL,
    dt_atualizacao          DATE NOT NULL
);
...
CREATE TABLE t_lista_ativ (
    cd_lista_ativ  INTEGER NOT NULL,
...
CREATE TABLE t_lista_hdor (
    cd_lista_hdor  INTEGER NOT NULL,
...
CREATE TABLE t_nivel_ativ (
    cd_nivel_ativ          INTEGER NOT NULL,
    t_cadastro_cd_usuario  INTEGER NOT NULL,
    t_tipo_nivel_cd_nivel  INTEGER NOT NULL,
    dt_atualizacao         DATE NOT NULL
);
...
CREATE TABLE t_pedido (
    ...
    t_premium_cd_premium  INTEGER NOT NULL,
    t_desconto_cd_cupom   INTEGER,
...
CREATE TABLE t_premium (
    cd_premium            INTEGER NOT NULL,
    t_plano_cd_plano      INTEGER NOT NULL,
    t_periodo_cd_periodo  INTEGER NOT NULL,
...
CREATE TABLE t_refeicao (
    t_tipo_refeicao_cd_tipo_ref  INTEGER NOT NULL,
    t_cadastro_cd_usuario        INTEGER NOT NULL,
    t_alimento_cd_alimento       INTEGER NOT NULL,
